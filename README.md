...
Accessibility means to be developed in a way so everyone can use it regardless of their disability - example ...colorblindness.

2. Talk about 3 different things you can do to ensure your website is accessible.

-use easy to read font and size of the font;
-use the right colors and background colors;
-menu and links must be easy to accses and use.
